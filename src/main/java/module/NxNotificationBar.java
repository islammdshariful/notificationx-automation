...
import utils.Config;
import pom.nxNotificationBarUtils;
import pom.nxNotificationBarUtils.CountDown_TEXT;

public class NxNotificationBar {

    public static void createNotificationBar(WebDriver driver, String edit_url, byte theme) {
        try {
            driver.get(edit_url);
            // LOGIN
...
//			driver.findElement(By.xpath(nxNotificationBarUtils.CountDown_Locator.arrow_next_xpath)).click();
    ...
    public static void nxBar(WebDriver driver, byte theme) {
