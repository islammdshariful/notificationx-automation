...
import module.NxDownloadStatNotification;
import utils.Config;
import utils.DriverManager;
import utils.WordpressLogin;

import static module.NxDownloadStatNotification.createnxDownStatNotification;
import static module.NxDownloadStatNotification.downloadStatNotification;
...
public class NXDownloadStat {
    ...
    public void nxCommentsTestCase() {
        ...
        createnxDownStatNotification(driver, Config.URLS.admin_url);
